...
export const SECTIONS = {
  ...
  venue: {
    ...
    mapSrc: "https://maps.google.com/maps?q=NTR%20Stadium%20Hyderabad&t=&z=14&ie=UTF8&iwloc=&output=embed",
    directionsUrl: "https://maps.google.com/?q=NTR+Stadium+Hyderabad",
    directionsLabel: "Get Directions",
    venueTeamLabel: "Contact the Venue Team",
    access: [
      { icon: Plane, label: "Rajiv Gandhi Intl. Airport", value: "~45 min drive" },
      { icon: TramFront, label: "RTC X Roads Metro Station (Green Line)", value: "~7 min" },
      { icon: CarIcon, label: "On-site parking", value: "300+ bays" },
    ],
  },
  ...
  ctaBand: {
    ...
    subtitle: "Stalls and passes are limited. Secure your spot at Maha Auto Mela 2026 today.",
    ctaPrimary: { label: "Exhibitor Registration", to: "/exhibitors" },
  ...
  partnersSection: {
    ...
    heading: {
      ...
      subtitle: "Government bodies, trade associations, premier institutes and changemakers standing together behind Maha Auto Mela 2026.",
      align: "center" as const,
    } as HeadingConfig,
  ...
  contactMethods: {
    ...
    items: [
      ...
      { icon: MapPin, label: "Visit Us", value: "NTR Stadium, Hyderabad", href: "https://maps.google.com/?q=NTR+Stadium+Hyderabad" },
      { icon: Clock, label: "Expo Hours", value: "10 AM – 7 PM Daily", href: "" },
    ],
  },
  ...
  contactMap: {
    ...
    align: "center" as const,
    mapSrc: "https://maps.google.com/maps?q=NTR%20Stadium%20Hyderabad&t=&z=14&ie=UTF8&iwloc=&output=embed",
    directionsUrl: "https://maps.google.com/?q=N+International+Exhibition+Centre+NTR Stadium, Hyderabad",
