...
export const FALLBACK_FAQS_RAW = [
  { enabled: true,  q: "When and where is the expo held?", a: "Maha Auto Mela 2026 runs from 2–4 October 2026 at the NTR Stadium, Hyderabad, India. Doors open daily from 10:00 AM to 7:00 PM, with business hours from 9:00 AM." },
